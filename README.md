...
## Author
* **`Kelvin Likollari`** 
### Contact @  (kelvin.likollari@usi.ch), (kelvilikol13@gmail.com)
...
To run this application, with the TUI, **run the run() method located in the TuiUtil class of the TUI package.**
